...
<span class="left"><</span>UoH Location Services<span class="right">/></span>
    <div class="text">
        <span class="word">All Location</span><span class="web"> Results</span>
    </div>
</div>
</div>
<br> <br> 
...
<?php 
        ...
        <th> Date/Time </th>
            ...
            {
                $locationErr = "A location selection is Required to perform this Query";
            }
            else {
            ...
            if ($locationErr == "")
            {
                $select_query = "SELECT * FROM locationTable WHERE currentLocation LIKE '$location' ORDER BY currentDate DESC";          
