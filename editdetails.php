...
<span class="left"><</span>UoH Location Services<span class="right">/></span>
    <div class="text">
        <span class="word">Edit </span><span class="web">  Details </span>
    </div>
</div>
</div>

<div class="formcontainer">  
<form id="entry" action="editdetailsentry.php" method="post" name="submit">
    <h4> Edit existing details below: </h4>       
        <fieldset>
    ...
    <footer class = "footergeneral">Web Technologies ACW,    created by Brian Davis</footer> 
</body>
</html>