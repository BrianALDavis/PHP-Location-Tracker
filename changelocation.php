...
<head>
<title>Change Locations Page</title>
<meta charset="utf-8" />
...
<span class="left"><</span>UoH Location Services<span class="right">/></span>
    <div class="text">
        <span class="word">Change </span><span class="web"> Location</span>
    </div>
</div>
</div>

<div class="formcontainer">  
<form id="entry" action="changelocationresult.php" method="get" name="submit">
