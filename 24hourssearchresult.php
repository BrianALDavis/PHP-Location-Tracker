...
<head>
<title>24 Hours Search Result</title>
<meta charset="utf-8" />
...
<span class="left"><</span>UoH Location Services<span class="right">/></span>
    <div class="text">
        <span class="word">24 Hours </span><span class="web"> Results</span>
    </div>
</div>
</div>
<br> <br> 
...
<?php 
        ...
        <th> Date/Time </th>
            ...
            $select_query = "SELECT * FROM locationTable WHERE UserID LIKE '$userid' AND currentDate >= DATEADD(day, -1, getdate()) ORDER BY currentDate DESC";          
